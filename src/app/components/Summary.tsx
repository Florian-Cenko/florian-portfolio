  ...
  return (
    <section className="py-24 bg-[var(--background)] mb-24">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="bg-[var(--card-bg)] p-6 md:p-10 rounded-2xl shadow-md space-y-4">
          <p className="text-[var(--secondary)] leading-relaxed">
            Recent Applied Informatics graduate with a strong interest in full-stack software development and data-oriented applications. Familiar with Python, Java, and building small-scale projects.
          </p>
          <p className="text-[var(--secondary)] leading-relaxed">
