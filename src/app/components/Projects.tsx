        ...
        <div className="relative">
          <div ref={sliderRef} className="keen-slider">
            {projects.slice(0, 6).map((project, index) => (
              <div
                key={index}
                className="keen-slider__slide bg-[var(--card-bg)] p-6 rounded-2xl border border-transparent hover:border-[var(--accent)] shadow-md hover:shadow-xl transition-all flex flex-col min-h-[460px]"
              >
                {/* Title */}
                ...
                {/* Category */}
                <p className="text-xs uppercase tracking-wide text-[var(--accent)] mb-4">
                  {project.category}
                </p>

                {/* Description */}
                <p className="text-sm text-[var(--secondary)] mb-4 whitespace-pre-line leading-relaxed">
                  {project.description}
                </p>
                  ...
                  <div className="mt-auto">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {project.tech.map((tech, i) => (
                        <span
                          key={i}
                          className="text-xs px-3 py-1 rounded-fullbg-[var(--primary)]/10 text-[var(--primary)] font-medium"
                        >
                          {tech}
                        </span>
                      ))}
